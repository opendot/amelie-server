class Api::V1::SessionEventsCollectionDetailedSerializer < ActiveModel::Serializer::CollectionSerializer
  ...
  def serializer_from_resource(resource, serializer_context_class, options)
    ...
    when TransitionToPageEvent
      return Api::V1::TransitionToPageEventDetailedSerializer.new(resource, options)
    when OperatorEvent
