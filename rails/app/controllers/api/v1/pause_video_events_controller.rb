class Api::V1::PauseVideoEventsController < Api::V1::SessionEventsController
  def create
  ...
  def broadcast_event_message
    ActionCable.server.broadcast("cable_#{ENV['SERVER_TO_DESKTOP_SOCKET_CHANNEL_NAME']}", {type: "PAUSE_VIDEO", data: {card_id: session_event_params[:card_id]}}.to_json)
  end
