...
superadmin = Superadmin.create!(id: "superadmin", email: "admin@mail.it", password: "password", password_confirmation: "password", name: "Superadmin", surname: "Test")
puts "email: #{superadmin.email}"
therapist1 = Therapist.create!(id: "therapist1", email: "therapist1@mail.it", password: "password", password_confirmation: "password", name: "Therapist", surname: "1")
puts "email: #{therapist1.email}"
therapist2 = Therapist.create!(id: "therapist2", email: "therapist2@mail.it", password: "password", password_confirmation: "password", name: "Therapist", surname: "2")
puts "email: #{therapist1.email}"
teacher1 = Teacher.create!(id: "teacher1", email: "teacher1@mail.it", password: "password", password_confirmation: "password", name: "Teacher", surname: "1")
puts "email: #{therapist1.email}"
teacher2 = Teacher.create!(id: "teacher2", email: "teacher2@mail.it", password: "password", password_confirmation: "password", name: "Teacher", surname: "2")
puts "email: #{therapist1.email}"
puts "------------------------------------------------------"

puts ""

puts "Creating some patients and parents"
puts "------------------------------------------------------"
patients = []
5.times do |i|
  ...
  parent = Parent.create!(id: "parent#{i}", email: "parent#{i}@mail.it", password: "password", password_confirmation: "password", name: FFaker::NameIT.first_name, surname: patient.surname)
...
puts "Add patients to therapists"
therapist1.add_patient(Patient.find(patients[1]))
teacher1.add_patient(Patient.find(patients[1]))
therapist2.add_patient(Patient.find(patients[2]))
teacher2.add_patient(Patient.find(patients[2]))
...
targets.length.times do |i|
  ...
  1.times do |j|
    ...
    PageLayout.create!(page: presentation_page, card: presentation_card, x_pos: 0.3, y_pos: 0.1, scale: 1)
